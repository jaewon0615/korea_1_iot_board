...
public class ArticleServiceImpl implements ArticleService {
    ...
    @Override
    public ResponseDto<ArticleResponseDto> updateArticle(Long authorId, Long id, ArticleCreateRequestDto dto) {
        return null;
    }
    ...
    @Override
    public ResponseDto<ArticleResponseDto> getEditableArticle(Long id) {
        return null;
    }
